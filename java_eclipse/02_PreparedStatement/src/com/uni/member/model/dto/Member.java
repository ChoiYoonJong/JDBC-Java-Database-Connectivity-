...
//데이터 베이스에서 가지고온 한행의 정보를 담는 객체
//입출력이 일어나기 때문에 implements 작성
public class Member implements Serializable {/**
	 * 
	 */
	private static final long serialVersionUID = 6346615596757676147L; //serial ID 

	
	//1. 필드변수 컬럼에 대응~
	//네트워크 상으로 데이터 처리하기때문에 직렬화 처리
	//sql 데이터 타입을 사용하면 sql 데이터 형식이 있어서 추가로 변환할 필요가 없다.
