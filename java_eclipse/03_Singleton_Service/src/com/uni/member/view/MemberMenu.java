...
public class MemberMenu {
	...
	public void mainMenu() {
		...
		do {// 최초한번은 실행하기위해 do ~ while 생성
			...
			System.out.println("7.탈퇴 회원 조회");//update
			...
			case 6: // choice 6번 정보 회원 탈퇴
				...
				break;
			case 7: // choice 7번 정보 탈퇴 회원 조회
				mController.selectAllDeleteMember(); // //mController 에 selectAllDeleteMember(탈퇴 회원 조회 이거로이름 정함),
				break;
			case 9:
